...
<div className=" flex flex-col justify-start items-center  gap-5 w-80 h-96 overflow-y-scroll   p-8 m-5 shadow-2xl ">
...
<div className="flex flex-col  justify-start items-center    gap-10 w-80 h-96 overflow-y-scroll p-8 m-5 shadow-2xl ">
