...
<section className=" font-serif text-[#113744]   "style={{backgroundImage: "url('') "  , }}>
  ...
  <div className="  rounded flex justify-center items-center m-2  p-2  w-[50%] ">
    <img src={ak} alt="img" className="w-48 rounded shadow-2xl p-2" />
  </div>
  <div  className="sm:w-[50%] w-full h-full scale" >
...
<section style={{backgroundImage: "url('') "  , }} className="  flex flex-col sm:flex-row justify-evenly font-mono text-white items-center  shadow-2xl  p-10 ">
  ...
  <div className=" shadow-2xl  rounded   p-2 h-full">
  ...
  <div className="shadow-2xl p-2 w-full h-auto  rounded ">
