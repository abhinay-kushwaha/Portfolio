...
<section className=" font-serif text-[#113744]   "style={{backgroundImage: "url('') "  , }}>
  ...
  <div data-aos="zoom-out" className="sm:w-[50%] w-full h-full scale" >
    ...
    "I completed my engineering diploma from a Government Polytechnic college Rewa, and I'm currently in my second year of engineering studies from Malwa Institute of Science & Technology Indore. I'm passionate about delving into the intricacies of technology and problem-solving, and I'm excited about the opportunities that lie ahead in my engineering journey. My time in college has been rewarding, and I'm eager to continue learning and growing in my field. I'm particularly interested in Web developer.  I look forward to discussing how my skills and experience can contribute to your team's success. "
    </div>
  </div>
  </div>
</section>
<section style={{backgroundImage: "url('') "  , }} className="  flex flex-col sm:flex-row justify-evenly font-mono text-white items-center  shadow-2xl  p-10 ">
  ...
  <div data-aos="fade-down-right" className="   rounded   p-2 h-full">
  ...
  <div data-aos="fade-down-left" className=" p-2 w-full h-auto  rounded ">
